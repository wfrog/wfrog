...
set pkg_libusb10=http://libusb-winusb-wip.googlecode.com/files/libusb_2011.09.07.7z
set pkg_libusb0=http://sourceforge.net/projects/libusb-win32/files/libusb-win32-releases/1.2.5.0/libusb-win32-bin-1.2.5.0.zip/download
...
set tool_zadig=http://sourceforge.net/projects/libwdi/files/zadig/zadig_v1.1.1.140.7z/download