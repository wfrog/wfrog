...
set pkg_libusb10=http://libusb-winusb-wip.googlecode.com/files/libusb_2011.05.10.7z
...
set tool_zadig=http://sourceforge.net/projects/libwdi/files/zadig/zadig_v1.1.1.137.7z/download