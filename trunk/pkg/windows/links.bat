...
set pkg_libusb10=http://libusb-winusb-wip.googlecode.com/files/libusb_2012.01.08.7z
set pkg_libusb0=http://sourceforge.net/projects/libusb-win32/files/libusb-win32-releases/1.2.6.0/libusb-win32-bin-1.2.6.0.zip/download

set pkg_py2exe=http://sourceforge.net/projects/py2exe/files/py2exe/0.6.9/py2exe-0.6.9.win32-py2.6.exe/download
set pkg_pyyaml=http://pyyaml.org/download/pyyaml/PyYAML-3.10.win32-py2.6.exe
set pkg_pywws=http://pywws.googlecode.com/files/pywws-11.10_r429.zip
...
set pkg_pywin32=http://sourceforge.net/projects/pywin32/files/pywin32/Build216/pywin32-216.win32-py2.6.exe/download

set tool_zadig=http://sourceforge.net/projects/libwdi/files/zadig/zadig_v2.0.1.154.7z/download